...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'claims-adjuster'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Estimates', path: '/estimates', entity: 'estimate', service: AccessServiceEnum.PROJECT, icon: FiFileText },
