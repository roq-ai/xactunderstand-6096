...
import { useEstimateFindFirst, useRoqClient } from 'lib/roq';

import { EstimateInterface } from 'interfaces/estimate';
import { AdjustmentListPage } from 'pages/adjustments';

function EstimateViewPage() {
  ...
  const { data, error, isLoading } = useEstimateFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('estimate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/estimates/edit/${id}`} passHref legacyBehavior>
                    <Button
